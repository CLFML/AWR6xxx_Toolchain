 ...
 *
 * The two ranges below are the mmWave SDK's own address-translation LUT
 ...
 * here to cover all of DSS's L2/L3 memory instead of one fixed address.
 */
#ifndef DSS_MEM_H
#define DSS_MEM_H
 ...
 * outside both known ranges (DSS register space and TCM are NOT covered --
 * only L2/L3 program/data memory, all this example currently needs). */
